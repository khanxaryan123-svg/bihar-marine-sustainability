...
import { Icon, type IconKey, ArrowRight } from "@/components/shared/icons";
  ...
  return (
    ...
    >
      <div className="img-zoom-wrap relative w-full aspect-[16/10]">
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-ocean-900/70 via-ocean-900/10 to-transparent" />
      ...
      <div className="relative flex items-center justify-between gap-4 p-5 md:p-6">
        ...
        <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-ocean-50 text-ocean-700 group-hover:bg-ocean-500 group-hover:text-white transition-colors duration-300">
          <ArrowRight
            size={16}
